...
public class LojaProdutoResource extends RepresentationModel<LojaProdutoResource> {
	...
	public LojaProdutoResource(LojaProduto lojaProduto, boolean loadProdutoPreco, boolean loadLoja) {
		this.id = lojaProduto.getLoja().getId();
		this.nome = lojaProduto.getLoja().getNome();
		this.razaoSocial = lojaProduto.getLoja().getRazaoSocial();
		this.cnpj = lojaProduto.getLoja().getCnpj();
		this.ruaEnderecoComercial = lojaProduto.getLoja().getRuaEnderecoComercial();
		this.numeroEnderecoComercial = lojaProduto.getLoja().getNumeroEnderecoComercial();
		this.bairroEnderecoComercial = lojaProduto.getLoja().getBairroEnderecoComercial();
		this.cidadeEnderecoComercial = lojaProduto.getLoja().getCidadeEnderecoComercial();
		this.estadoEnderecoComercial = lojaProduto.getLoja().getEstadoEnderecoComercial();
		this.cepEnderecoComercial = lojaProduto.getLoja().getCepEnderecoComercial();
		this.telefoneContato = lojaProduto.getLoja().getTelefoneContato();

		horarioFuncionamentoSet.clear();
		for (HorarioFuncionamento horarioFuncionamento : lojaProduto.getLoja().getHorarioFuncionamentoSet()) {
		...
		if (loadProdutoPreco) {
			...
			produtoPrecoSet.add(new ProdutoPrecoResource(new ProdutoResource(lojaProduto.getProduto(), loadLoja), lojaProduto.getPreco()));
		}
